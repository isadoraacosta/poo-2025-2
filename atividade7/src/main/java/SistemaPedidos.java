...
public class SistemaPedidos {
    public static void main(String[] args) {
        ...
        Produto p1 = new Produto("1A", "Relógio", 100.00, "bom");

        Produto p2 = new Produto("1B", "Pulseira", 50.00, "bom");

        Produto p3 = new Produto("1C", "Colar", 1000, "bom");

        Produto p4 = new Produto("1D", "Anel", 80.00, "bom");
